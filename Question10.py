...
# variance empirique de l'estimateur de phase 
var_empirique=""" code python manquant """
# var théorique de l'estimateur de phase 
var_theorique=""" code python manquant """
print('variance empirique= ',var_empirique, ' variance théorique= ',var_theorique)
